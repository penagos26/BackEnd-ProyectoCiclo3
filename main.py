...
async def Obtener_cliente(cliente_in: ClientesIn):
    clientes_in_db = get_cliente(cliente_in.cc)
...
async def Obtener_compras(cliente_in: ClientesIn):
    compras_in_db = get_Compra_Cliente(cliente_in.cc)
    compras_out = []
